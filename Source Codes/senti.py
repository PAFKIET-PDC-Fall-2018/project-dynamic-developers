...
def scrape(usr,pgs): # method called by finalmpi.py for scraping tweets by username [By S M Fasih Ali 60838]
  try:
    arr = get_tweets(usr,pages=pgs) # get_tweets takes two argument username and number of pages max 25pgs  [By S M Fasih Ali 60838]
